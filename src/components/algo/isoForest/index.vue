  ...
  <div class="algo">
    <div class="predict" style="margin-bottom: 20px;">
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="">
          <el-input v-model="formInline.totalp" placeholder="总磷 " style="width: 210px;"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="alert alert-info" role="alert">
      <h1>Prompt</h1>
      <div>
        <p><font size="4">下面异常数据信息中，异常数据均值、正常数据均值等以列表展示出来的信息，数据从左到右分别代表ph、溶解氧、氨氮、高锰酸盐、总磷</font></p>
      </div>
    </div>
    
    <div class="errorInfos" v-loading="loading" element-loading-text="数据正在加载中" element-loading-spinner="el-icon-loading"
      ...
      <div class="errInfo" v-for="(item,index) in errInfos" :key='index' style="margin-bottom: 10px;">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            ...
            <!--<span class="badge badge-danger" v-if='item.bad_percent >= 0.2' style="float: right;">Danger</span>
