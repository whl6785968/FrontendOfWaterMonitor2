...
export function getErrStation(){
  return request({
    url: '/bd/basic/getErrStation',
    method: 'get'
  })
}

export function getErrStationAndRecord(){
  return request({
    url: '/bd/basic/getErrStationAndRecord',
    method: 'get'
  })
}
...
export function getNewestData(){
  return request({
    url: '/report/basic/getNewestData',
    method: 'get'
  })
}
